...
class LexerConfig private constructor(
    ...
    class Builder {
        ...
        fun defaultRules(): Builder {
            ...
            rule(LexerRule.literal("modifier", TokenKinds.Modifier, "modifier"))
            ...
            rule(LexerRule.literal("left brace", TokenKinds.LeftBrace, "{"))
            rule(LexerRule.literal("right brace", TokenKinds.RightBrace, "}"))
            rule(LexerRule.literal("left bracket", TokenKinds.LeftBracket, "["))
            rule(LexerRule.literal("right bracket", TokenKinds.RightBracket, "]"))
            rule(LexerRule.literal("equals", TokenKinds.Equals, "="))
            rule(LexerRule.literal("semicolon", TokenKinds.Semicolon, ";"))
            rule(LexerRule.literal("colon", TokenKinds.Colon, ":"))
            rule(LexerRule.literal("comma", TokenKinds.Comma, ","))
            rule(LexerRule.literal("question", TokenKinds.Question, "?"))
