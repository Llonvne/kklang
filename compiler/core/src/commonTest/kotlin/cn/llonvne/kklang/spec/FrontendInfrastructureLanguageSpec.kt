...
val frontendInfrastructureSpec = languageSpec("frontend-infrastructure") {
    ...
    lexer {
        ...
        token("modifier", "modifier keyword")
        token("left_paren", "(")
        token("right_paren", ")")
        token("left_brace", "{")
        token("right_brace", "}")
    ...
    parser {
        ...
        prefix("modifier declaration", "modifier")
        prefix("raw modifier application", "identifier")
        prefix("identifier expression", "identifier")
        prefix("integer expression", "integer")
        prefix("string expression", "string")
        prefix("call expression", "identifier", precedence = 40)
